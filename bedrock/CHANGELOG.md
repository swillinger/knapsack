...
* build writes out meta.json with demo urls ([6e77394](https://github.com/basaltinc/bedrock/commit/6e77394))
...
* stringified boolean and integer data ([ee652bb](https://github.com/basaltinc/bedrock/commit/ee652bb))
...
* template character limit ([a1911fb](https://github.com/basaltinc/bedrock/commit/a1911fb))
...
* improve handling of absent statuses ([0eda5c8](https://github.com/basaltinc/bedrock/commit/0eda5c8))
...
* **bedrock:** prevent distDir from too-early clean ([e85d449](https://github.com/basaltinc/bedrock/commit/e85d449))
* **bedrock:** serving bedrock distDir instead of copying in build ([35e6c68](https://github.com/basaltinc/bedrock/commit/35e6c68))
...
* template reloads for all extensions ([f541c49](https://github.com/basaltinc/bedrock/commit/f541c49))
...
* **bedrock:** add loglevel cli flag ([b8ca890](https://github.com/basaltinc/bedrock/commit/b8ca890))
...
* **bedrock:** setup events system ([240a4cc](https://github.com/basaltinc/bedrock/commit/240a4cc))
...
* **bedrock:** iFrame resize bug on Templates ([51dc17b](https://github.com/basaltinc/bedrock/commit/51dc17b))
...
* **bedrock:** lint fix and bring back buttons with clear disable marker ([9943667](https://github.com/basaltinc/bedrock/commit/9943667))
...
* **bedrock:** hotfix enable ui editing ([#159](https://github.com/basaltinc/bedrock/issues/159)) ([363866f](https://github.com/basaltinc/bedrock/commit/363866f))
...
* fix settings design tokens bug ([725d2cc](https://github.com/basaltinc/bedrock/commit/725d2cc))
...
* **bedrock:** disabling ability to create new patterns via ui for now ([9385ce9](https://github.com/basaltinc/bedrock/commit/9385ce9))
* **bedrock:** enabling UI settings for staging, for now ([b1f1d01](https://github.com/basaltinc/bedrock/commit/b1f1d01))
